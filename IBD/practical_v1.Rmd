...
<br> 
There are many ways to estimate relatedness among individuals. One method you may have encountered in the past is [phylogenetic trees](https://en.wikipedia.org/wiki/Phylogenetic_tree), which is a common approach for modeling relationships between bacterial and viral pathogens. However, in recombining pathogens, like malaria, phylogenetic approaches are complicated (due to underlying assumptions of nonrecombining regions). Instead, we can leverage our knowledge about recombination and use it to estimate relatedness through identity. 

<br> 
In the schematic below, a single mosquito has bitten two different individuals infected with a single strain of the malaria parasite, resulting in a superinfection. The two strains (red vs purple) then undergo recombination in the mosquito midgut and produce progeny that are siblings and expected to share half of their genomes on average. 
<br>
...
<p align="center">
![](https://raw.githubusercontent.com/mrc-ide/AMMS2022/master/IBD/R_ignore/images/mini_arg.png){width="500px"}
</p>
<br> 
<br> 
<br> 
...
```
_**Conceptual Question:** What can highly related pairs tell you? How do they relate to transmission events? Can you use them to estimate genetic corridors or evidence fo gene flow? Do you think there is active transmission between the mainland and island (see original study hypothesis)?_ 
<br>
<br>


## Self Exploration
You have reached the end of the practical. If time permits, you can explore this [Shiny app]() which will allow you to simulate new genetic data and explore how different parameters (COI, migration, population size) affect IBD.  

# Advanced/Extra
This section contains advanced material and additional resources for interested participants.   
...
## Manipulating VCFs
If time permits, check out [`vcftools`](https://vcftools.github.io/index.html). Try and subset our VCF to sample "A1" from the command line. Now try and subset to a single loci.   
Manipulating VCFs on the command line is a key skill for a bioinformatician!  
<br> 
<br>
